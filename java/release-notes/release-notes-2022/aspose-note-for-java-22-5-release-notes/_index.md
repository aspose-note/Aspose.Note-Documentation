...
type: docs
weight: 33
url: /java/aspose-note-for-java-22-5-release-notes/
---

{{% alert color="primary" %}} 

This page contains release notes information for [Aspose.Note for Java 22.5](https://downloads.aspose.com/note/java/new-releases/aspose.note-for-java-22.5/).
